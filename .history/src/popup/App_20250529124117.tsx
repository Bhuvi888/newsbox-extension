...
export default function App() {
  ...
  return (
    <div
      className={`w-[640px] h-[600px] overflow-y-auto rounded-xl shadow-xl border transition-colors duration-300 ${darkMode ? "bg-gray-900 text-white" : "bg-white text-black"}`}
    >
                  ...
                  <div className="flex justify-between items-start">
                    <div className="pr-2">
                      ...
                      <a
                        ...
                        className="text-xs mt-2 inline-block text-blue-500"
                      >
                        {news.source.name}
                      </a>
                    </div>
