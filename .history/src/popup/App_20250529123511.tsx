...
export default function App() {
  ...
  return (
    <div
      className={`w-[360px] h-[600px] overflow-y-auto rounded-xl shadow-xl border transition-colors duration-300 ${darkMode ? "bg-gray-900 text-white" : "bg-white text-black"}`}
    >
