...
const categoryToQuery: Record<string, string> = {
  Headlines: "general OR world OR nation",
  Tech: "technology",
  Movies: "entertainment",
  "Nerd Corner": "anime OR gaming OR sports OR science",
};
...
export default function App() {
  ...
  return (
    <div
      className={`w-[640px] h-[480px] overflow-y-auto  shadow-xl border transition-colors duration-300 ${
          ...
          <button
            ...
            className={`capitalize px-3 py-1 rounded transition-colors ${
              activeTab === cat
                ...
                : "bg-transparent text-inherit hover:bg-gray-50 dark:hover:bg-gray-800"
            }`}
          ...
          newsData.map((news, i) => (
            ...
            >
              <Card className="rounded-xl shadow border bg-opacity-60 backdrop-blur-md">
                <CardContent className={`overflow-clip ${darkMode ? "text-white" : "text-black"}`}>
